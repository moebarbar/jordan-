        ...
        <div className="border-t border-kaleo-cream/10 py-6">
          <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="md:w-1/3 flex justify-center md:justify-start">
              <p className="font-body text-xs text-kaleo-cream/40 text-center md:text-left">
            ...
            <div className="md:w-1/3 flex justify-center text-center">
              <p className="font-body text-xs text-kaleo-cream/40">
                built with ❤️ by <a href="https://www.instagram.com/immoebarbar" target="_blank" rel="noopener noreferrer" className="text-kaleo-cream hover:text-kaleo-terracotta transition-colors">Mohammad Barbar</a>
              </p>
            </div>
